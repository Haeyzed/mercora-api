...
renewAfterPayment reactivates suspended tenants and EntitlementService::forget (versioned cache). Immediate/finalized cancel voids open invoices and marks pending payments Cancelled. changePlan preserves billing period dates; when subscriptions.prorate_plan_changes is true and terms changed, issues an open invoice for remaining-period fraction of the new price and may set PendingPayment.
