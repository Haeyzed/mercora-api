...
class InvoiceService
{
     ...
     * @throws ValidationException|Throwable When the subscription is not current.
     */
     ...
     * @throws ModelNotFoundException|Throwable When the invoice row disappears during the transaction.
     */
